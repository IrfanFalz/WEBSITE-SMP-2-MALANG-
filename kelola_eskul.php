...
if (isset($_GET['delete'])) {
    ...
    // Redirect kembali ke halaman kelola ekstrakurikuler
...
<body>
    ...
    <a href="tambah_eskul.php" class="add-button">Tambah Ekstrakurikuler</a>
    <table>
        <tr>
            <th>Gambar</th>
        ...
        <tr>
            <td><img src="uploads/<?= $row['gambar']; ?>" alt="Ekstrakurikuler"></td>
            <td><?= $row['nama_eskul']; ?></td>
            <td class="action-cell">
                <a href="edit_eskul.php?id=<?= $row['id']; ?>" class="btn btn-edit">Edit</a>
                <a href="kelola_eskul.php?delete=<?= $row['id']; ?>" onclick="return confirm('Hapus Ekstrakurikuler ini?')" class="btn btn-delete">Hapus</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
